...
export const VOCABULARY_LIST: Vocabulary[] = [
  ...
  // --- Lesson 4 ---
  { lessonId: 'L4', word: '起きます', reading: 'おきます', meaning: '起床', type: 'verb' },
  { lessonId: 'L4', word: '寝ます', reading: 'ねます', meaning: '睡觉', type: 'verb' },
  { lessonId: 'L4', word: '働きます', reading: 'はたらきます', meaning: '工作', type: 'verb' },
  { lessonId: 'L4', word: '休みます', reading: 'やすみます', meaning: '休息', type: 'verb' },
  { lessonId: 'L4', word: '勉強します', reading: 'べんきょうします', meaning: '学习', type: 'verb' },
  { lessonId: 'L4', word: '終わります', reading: 'おわります', meaning: '结束', type: 'verb' },
  ...
  // --- Lesson 5 ---
  { lessonId: 'L5', word: '行きます', reading: 'いきます', meaning: '去', type: 'verb' },
  { lessonId: 'L5', word: '来ます', reading: 'きます', meaning: '来', type: 'verb' },
  { lessonId: 'L5', word: '帰ります', reading: 'かえります', meaning: '回去', type: 'verb' },
  ...
  // --- Lesson 6 ---
  { lessonId: 'L6', word: '食べます', reading: 'たべます', meaning: '吃', type: 'verb' },
  { lessonId: 'L6', word: '飲みます', reading: 'のみます', meaning: '喝', type: 'verb' },
  { lessonId: 'L6', word: '吸います', reading: 'すいます', meaning: '吸(烟)', type: 'verb' },
  { lessonId: 'L6', word: '見ます', reading: 'みます', meaning: '看', type: 'verb' },
  { lessonId: 'L6', word: '聞きます', reading: 'ききます', meaning: '听', type: 'verb' },
  { lessonId: 'L6', word: '読みます', reading: 'よみます', meaning: '读', type: 'verb' },
  { lessonId: 'L6', word: '書きます', reading: 'かきます', meaning: '写', type: 'verb' },
  { lessonId: 'L6', word: '買います', reading: 'かいます', meaning: '买', type: 'verb' },
  { lessonId: 'L6', word: '撮ります', reading: 'とります', meaning: '拍(照)', type: 'verb' },
  { lessonId: 'L6', word: 'します', reading: 'します', meaning: '做', type: 'verb' },
  { lessonId: 'L6', word: '会います', reading: 'あいます', meaning: '见面', type: 'verb' },
  ...
  // --- Lesson 7 ---
  { lessonId: 'L7', word: '切ります', reading: 'きります', meaning: '切/剪', type: 'verb' },
  { lessonId: 'L7', word: '送ります', reading: 'おくります', meaning: '寄/送', type: 'verb' },
  { lessonId: 'L7', word: 'あげます', reading: 'あげます', meaning: '给', type: 'verb' },
  { lessonId: 'L7', word: 'もらいます', reading: 'もらいます', meaning: '得到', type: 'verb' },
  { lessonId: 'L7', word: '貸します', reading: 'かします', meaning: '借出', type: 'verb' },
  { lessonId: 'L7', word: '借ります', reading: 'かります', meaning: '借入', type: 'verb' },
  { lessonId: 'L7', word: '教えます', reading: 'おしえます', meaning: '教', type: 'verb' },
  { lessonId: 'L7', word: '習います', reading: 'ならいます', meaning: '学习', type: 'verb' },
  { lessonId: 'L7', word: 'かけます', reading: 'かけます', meaning: '打(电话)', type: 'verb' },
  ...
  // --- Lesson 9 ---
  { lessonId: 'L9', word: '分かります', reading: 'わかります', meaning: '懂/明白', type: 'verb' },
  { lessonId: 'L9', word: 'あります', reading: 'あります', meaning: '有', type: 'verb' },
  ...
  // --- Lesson 10 ---
  { lessonId: 'L10', word: 'います', reading: 'います', meaning: '有(人/动物)', type: 'verb' },
  { lessonId: 'L10', word: 'あります', reading: 'あります', meaning: '有(物)', type: 'verb' },
  ...
  // --- Lesson 11 ---
  { lessonId: 'L11', word: 'います[子どもが]', reading: 'います', meaning: '有[孩子]', type: 'verb' },
  { lessonId: 'L11', word: 'います[日本に]', reading: 'います', meaning: '在[日本]', type: 'verb' },
  { lessonId: 'L11', word: 'かかります', reading: 'かかります', meaning: '花费(时间/金钱)', type: 'verb' },
  { lessonId: 'L11', word: '休みます[会社を]', reading: 'やすみます', meaning: '请假', type: 'verb' },
...
export const EXERCISES: Exercise[] = [
  // ... (Existing exercises remain unchanged as they were correct, 
  // can be expanded later but focus was on Grammar text update)
  // --- Lesson 1 ---
